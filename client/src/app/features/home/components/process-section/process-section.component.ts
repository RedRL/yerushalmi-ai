...
const PROCESS_STEPS: readonly ProcessStep[] = [
  ...
  { step: 2, titleHe: 'מתאימים את האפשרויות', descriptionHe: 'בוחרים סוג וידאו, כתוביות, פורמטים, אורך ותוספות.' },
  {
    ...
    descriptionHe: 'מספרים על האדם, מעלים תמונות במידת הצורך ושולחים את כל המידע החשוב.',
  },
  {
    step: 4,
    titleHe: 'אני עובר על הבקשה',
    descriptionHe: 'לאחר מעבר על החומרים והפרטים, אני חוזר אליכם לאישור סופי ולהמשך התהליך.',
  },
];
