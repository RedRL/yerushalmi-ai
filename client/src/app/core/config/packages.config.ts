...
export const PACKAGE_DEFINITIONS: readonly PackageDefinition[] = [
  {
    ...
    featuresHe: [
      ...
      '✔ סבב תיקונים אחד לשיר',
      '✔ מסירה עד 7 ימי עסקים',
  ...
  },
  {
    ...
    descriptionHe: 'יוצרים סרטון מרגש ומרשים שמספר את הסיפור שלכם, לרקע שיר לבחירתכם — לאירועים, למשפחה, לחברות ולארגונים.',
    featuresHe: [
      '✔ קליפ בהתאמה אישית',
      '✔ שימוש בשיר לבחירתכם',
      '✔ סבב תיקונים אחד לסרטון',
      '✔ מסירה עד 7 ימי עסקים',
  ...
  },
  {
    ...
    descriptionHe: 'מהרעיון הראשון ועד הסרטון המוגמר – כל החוויה במקום אחד. מתאים לאירועים, למשפחה, לחברות ולארגונים.',
    featuresHe: [
      '✔ מילים בהתאמה אישית',
      '✔ שיר מקורי בהתאמה אישית',
      '✔ קליפ בהתאמה אישית',
      '✔ סבב תיקונים אחד לשיר וסבב אחד לקליפ',
      '✔ מסירה עד 7 ימי עסקים',
      '✔ סרטון באיכות Full HD',
    ],
    introPrice: 1190,
