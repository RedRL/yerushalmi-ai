...
export function buildInquiryConfirmationEmail(params: {
  ...
  const bodyLines = [
    ...
    '3. לאחר האישור שלנו שהעבודה החלה — מתחילים ליצור. המסירה היא עד שבעה ימי עסקים מאותו מועד (בקשה אחרי 17:00 נספרת מיום העסקים הבא)',
    '',
                  ...
                  <td style="padding:10px 0;">
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="font-size:15px;line-height:1.6;color:#374151;">לאחר האישור שלנו שהעבודה החלה — מתחילים ליצור. המסירה היא עד שבעה ימי עסקים מאותו מועד (בקשה אחרי 17:00 נספרת מיום העסקים הבא)</td>
                      </tr>
                    </table>
                  </td>
                </tr>
